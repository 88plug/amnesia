...
!!! note
    Recommended install is via the [88plug marketplace](https://github.com/88plug/claude-code-plugins). Installing directly from this repo also works but is less convenient and will not auto-update with curated releases. The plugin package lives under [`plugins/amnesia`](https://github.com/88plug/amnesia/tree/main/plugins/amnesia).
...
??? note "Per-call cost detail (verified 2026-05-24)"
